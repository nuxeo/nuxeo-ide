...
public class DialogBot {
    ...
    protected static <T extends DialogBot> T newDialog(
    ...
    public static <T extends DialogBot> T asyncOpen(SWTWorkbenchBot workbench,
    ...
    public static <T extends DialogBot> T asyncExecute(
